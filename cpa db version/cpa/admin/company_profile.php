                ...
                <form method="post" enctype="multipart/form-data" role="form" class="">
                  <div class="row">
                    ...
                    <div class="col-md-5 form-group mt-3 mt-md-0">
                      ...
                      value="<?php echo $home_page['company_name'];?>"
                      required>
                    </div>
                    <!-- Email Input -->
                    <div class="col-md-5 form-group mt-3 mt-md-0">
                      <label for="company_email">Company Email</label>
                      <input type="text" class="form-control" name="company_email" id="company_email" placeholder="Company Email" 
                      value="<?php echo $home_page['company_email'];?>"
                      required>
                    </div>
                  </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              United States <br><br>
              <strong>Phone: </strong>
              <a href="tel:<?php echo $home_page['company_phone'];?>">
                <?php 
                  $cell= $home_page['company_phone'];                  
                  echo "(".substr($cell,0,3).") ".substr($cell,3,3)." - ".substr($cell,6,4);
                ?>
              </a><br>
              <strong>Email: </strong>
              <a href="mailto:%20<?php echo $home_page['company_email'];?>?subject=Mail%20from%20Our%20Site">
                <?php 
                  echo $home_page['company_email'];
                ?>
              </a><br>
            </p>
          </div>
