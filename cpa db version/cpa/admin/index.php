    ...
    <section id="contact-form_data" class="contact-form_data">
      <div class="container position-relative" data-aos="fade-up">
        <div class="row gy-4 d-flex justify-content-center">
            <!-- Messages Count Card -->
            <div class="card text-center" style="width: auto; height:auto; margin-right: 1rem;">  
              <a href="contact_form_messages.php">
                <div class="card-body">
                  <h5 class="card-title">Messages</h5>
                  <span class="btn text-light bg-primary rounded-circle"><?php echo $count_messages['count'];?></span>                
                </div>
              </a>          
            </div>
            <!-- Home Page Edit Card -->
            <div class="card text-center" style="width: auto; height:auto; margin-left: 1rem; margin-right: 1rem;">  
              <a href="company_profile.php">
                <div class="card-body">
                  <h5 class="card-title">Profile</h5>
                  <span class="btn text-light bg-primary">Edit Profile</span>
                </div>
              </a>
            </div>
            <!-- Profile Edit Card -->
            <div class="card text-center" style="width: auto; height:auto; margin-left: 1rem;">  
              <a href="edit_home.php">
                <div class="card-body">
                  <h5 class="card-title">Home Page</h5>
                  <span class="btn text-light bg-primary">Edit Content</span>
                </div>
              </a>
            </div>
        </div>
